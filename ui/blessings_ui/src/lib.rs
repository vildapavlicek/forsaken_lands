...
pub fn spawn_blessings_content(
            ...
            for item in self.data {
                 ...
                 parent.commands().entity(card).with_children(|c| {
                     ...
                     spawn_action_button(
                        c,
                        "Upgrade",
                        if item.can_afford { UiTheme::AFFORDABLE } else { UiTheme::BORDER_DISABLED },
                        if item.can_afford { UiTheme::BORDER_SUCCESS } else { UiTheme::BORDER_DISABLED },
